...
search_query <- read_file("search_terms/qac_full_query_with_exclusions.txt")
search_query <- gsub("[\r\n]", " ", search_query)
```
...
```{r}
getwd()
search_1 <- read_file("search_terms/qac_chemical_string_841.txt")
search_2 <- read_file("search_terms/qac_general_chemical_terms.txt")
search_exclude <- read_file("search_terms/qac_exclusion_string.txt")
```
